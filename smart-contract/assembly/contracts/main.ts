...
const COUNTER_KEY: StaticArray<u8> = [0x42, 0x00];
const TOKEN_ID_KEY_PREFIX: StaticArray<u8> = [0x42, 0x01];
const TARGET_KEY_PREFIX: StaticArray<u8> = [0x42, 0x02];
const DOMAIN_KEY_PREFIX: StaticArray<u8> = [0x42, 0x03];
const ADDRESS_KEY_PREFIX: StaticArray<u8> = [0x42, 0x04];
