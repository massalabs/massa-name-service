...
export interface IPublicServiceClient {
  ...
  executeReadOnlyCall(
    ...
    options?: RpcOptions,
  ): UnaryCall<ExecuteReadOnlyCallRequest, ExecuteReadOnlyCallResponse>;
  /**
   * Get blocks by ids
   *
   ...
   */
  getBlocks(
    input: GetBlocksRequest,
    options?: RpcOptions,
  ): UnaryCall<GetBlocksRequest, GetBlocksResponse>;
  /**
   ...
   */
  getDatastoreEntries(
    input: GetDatastoreEntriesRequest,
    options?: RpcOptions,
  ): UnaryCall<GetDatastoreEntriesRequest, GetDatastoreEntriesResponse>;
  /**
   ...
   */
  getEndorsements(
    input: GetEndorsementsRequest,
    options?: RpcOptions,
  ): UnaryCall<GetEndorsementsRequest, GetEndorsementsResponse>;
  /**
  ...
  getNextBlockBestParents(
    input: GetNextBlockBestParentsRequest,
    options?: RpcOptions,
  ): UnaryCall<GetNextBlockBestParentsRequest, GetNextBlockBestParentsResponse>;
  /**
  ...
  getOperations(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetOperationsRequest, GetOperationsResponse>;
  /**
  ...
  getScExecutionEvents(
    input: GetScExecutionEventsRequest,
    options?: RpcOptions,
  ): UnaryCall<GetScExecutionEventsRequest, GetScExecutionEventsResponse>;
  /**
   * Get selector draws
   *
   ...
   */
  getSelectorDraws(
    input: GetSelectorDrawsRequest,
    options?: RpcOptions,
  ): UnaryCall<GetSelectorDrawsRequest, GetSelectorDrawsResponse>;
  /**
   * Get stakers
   *
  ...
  getStakers(
    ...
    options?: RpcOptions,
  ): UnaryCall<GetStakersRequest, GetStakersResponse>;
  /**
   * Get status
   *
  ...
  getTransactionsThroughput(
    input: GetTransactionsThroughputRequest,
    options?: RpcOptions,
  ): UnaryCall<
   ...
   */
  queryState(
    input: QueryStateRequest,
    options?: RpcOptions,
  ): UnaryCall<QueryStateRequest, QueryStateResponse>;
  /**
   * Search blocks
   *
   ...
   */
  searchBlocks(
    input: SearchBlocksRequest,
    options?: RpcOptions,
  ): UnaryCall<SearchBlocksRequest, SearchBlocksResponse>;
  /**
   * Search endorsements
   *
   ...
   */
  searchEndorsements(
    input: SearchEndorsementsRequest,
    options?: RpcOptions,
  ): UnaryCall<SearchEndorsementsRequest, SearchEndorsementsResponse>;
  /**
   * Search operations
   *
   ...
   */
  searchOperations(
    input: SearchOperationsRequest,
    options?: RpcOptions,
  ): UnaryCall<SearchOperationsRequest, SearchOperationsResponse>;
  // ███████╗████████╗██████╗ ███████╗ █████╗ ███╗   ███╗
  // ██╔════╝╚══██╔══╝██╔══██╗██╔════╝██╔══██╗████╗ ████║
  // ███████╗   ██║   ██████╔╝█████╗  ███████║██╔████╔██║
  // ╚════██║   ██║   ██╔══██╗██╔══╝  ██╔══██║██║╚██╔╝██║
  ...
  newBlocks(
    options?: RpcOptions,
  ): DuplexStreamingCall<NewBlocksRequest, NewBlocksResponse>;
  /**
  ...
  newEndorsements(
    options?: RpcOptions,
  ): DuplexStreamingCall<NewEndorsementsRequest, NewEndorsementsResponse>;
  /**
  ...
  newFilledBlocks(
    options?: RpcOptions,
  ): DuplexStreamingCall<NewFilledBlocksRequest, NewFilledBlocksResponse>;
  /**
  ...
  newOperations(
    options?: RpcOptions,
  ): DuplexStreamingCall<NewOperationsRequest, NewOperationsResponse>;
  /**
  ...
  newSlotExecutionOutputsServer(
    input: NewSlotExecutionOutputsRequest,
    options?: RpcOptions,
  ): ServerStreamingCall<
    NewSlotExecutionOutputsRequest,
    NewSlotExecutionOutputsResponse
  ...
  sendBlocks(
    options?: RpcOptions,
  ): DuplexStreamingCall<SendBlocksRequest, SendBlocksResponse>;
  /**
   * Send endorsements
   *
  ...
  sendEndorsements(
    options?: RpcOptions,
  ): DuplexStreamingCall<SendEndorsementsRequest, SendEndorsementsResponse>;
  /**
   * Send operations
   *
  ...
  sendOperations(
    options?: RpcOptions,
  ): DuplexStreamingCall<SendOperationsRequest, SendOperationsResponse>;
  /**
...
export class PublicServiceClient implements IPublicServiceClient, ServiceInfo {
  ...
  getBlocks(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<GetBlocksRequest, GetBlocksResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  getEndorsements(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<GetEndorsementsRequest, GetEndorsementsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  getOperations(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<GetOperationsRequest, GetOperationsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  getSelectorDraws(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<GetSelectorDrawsRequest, GetSelectorDrawsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  getStakers(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<GetStakersRequest, GetStakersResponse>(
      'unary',
      this._transport,
      method,
      opt,
   ...
   * Query state
   *
   * @generated from protobuf rpc: QueryState(massa.api.v1.   ) returns (massa.api.v1.QueryStateResponse);
   */
  queryState(
    input: QueryStateRequest,
    options?: RpcOptions,
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<QueryStateRequest, QueryStateResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  searchBlocks(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<SearchBlocksRequest, SearchBlocksResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  searchOperations(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<SearchOperationsRequest, SearchOperationsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  newBlocks(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<NewBlocksRequest, NewBlocksResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  newEndorsements(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<NewEndorsementsRequest, NewEndorsementsResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  newFilledBlocks(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<NewFilledBlocksRequest, NewFilledBlocksResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  newOperations(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<NewOperationsRequest, NewOperationsResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  sendBlocks(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<SendBlocksRequest, SendBlocksResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  sendEndorsements(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<SendEndorsementsRequest, SendEndorsementsResponse>(
      'duplex',
      this._transport,
      method,
      opt,
  ...
  sendOperations(
    ...
    const opt = this._transport.mergeOptions(options);
    return stackIntercept<SendOperationsRequest, SendOperationsResponse>(
      'duplex',
      this._transport,
      method,
      opt,
