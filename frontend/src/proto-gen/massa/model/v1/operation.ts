...
class Operation$Type extends MessageType<Operation> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.OperationType op */ 3:
          message.op = OperationType.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.op,
  ...
  internalBinaryWrite(
    ...
    if (message.op)
      OperationType.internalBinaryWrite(
        message.op,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Transaction transaction */ 1:
          message.type = {
            ...
            transaction: Transaction.internalBinaryRead(
              ...
              reader.uint32(),
              options,
              (message.type as any).transaction,
            ),
          };
          break;
        case /* massa.model.v1.RollBuy roll_buy */ 2:
          message.type = {
            oneofKind: 'rollBuy',
            rollBuy: RollBuy.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).rollBuy,
            ),
          };
          break;
        case /* massa.model.v1.RollSell roll_sell */ 3:
          message.type = {
            oneofKind: 'rollSell',
            rollSell: RollSell.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).rollSell,
            ),
          };
          break;
        case /* massa.model.v1.ExecuteSC execut_sc */ 4:
          message.type = {
            oneofKind: 'executSc',
            executSc: ExecuteSC.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).executSc,
            ),
          };
          break;
        case /* massa.model.v1.CallSC call_sc */ 5:
          message.type = {
            oneofKind: 'callSc',
            callSc: CallSC.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.type as any).callSc,
            ),
          };
          break;
        default:
...
class SignedOperation$Type extends MessageType<SignedOperation> {
  constructor() {
    super('massa.model.v1.SignedOperation', [
      ...
      {
        no: 3,
        name: 'content_creator_pub_key',
        kind: 'scalar',
        T: 9 /* ScalarType.STRING*/,
      },
      {
        no: 4,
        name: 'content_creator_address',
        kind: 'scalar',
        T: 9 /* ScalarType.STRING*/,
      },
      {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Operation content */ 1:
          message.content = Operation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.SignedOperation operation */ 3:
          message.operation = SignedOperation.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.operation,
    ...
    super('massa.model.v1.OpTypes', [
      {
        ...
        kind: 'enum',
        repeat: 1 /* RepeatType.PACKED*/,
        T: () => ['massa.model.v1.OpType', OpType, 'OP_TYPE_'],
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated massa.model.v1.OpType op_types */ 1:
          ...
          else message.opTypes.push(reader.int32());
          break;
        default:
          let u = options.readUnknownField;
          if (u === 'throw')
