...
class DenunciationIndex$Type extends MessageType<DenunciationIndex> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.DenunciationBlockHeader block_header */ 1:
          message.entry = {
            oneofKind: 'blockHeader',
            blockHeader: DenunciationBlockHeader.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.entry as any).blockHeader,
            ),
          };
          break;
        case /* massa.model.v1.DenunciationEndorsement endorsement */ 2:
          message.entry = {
            oneofKind: 'endorsement',
            endorsement: DenunciationEndorsement.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.entry as any).endorsement,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.entry.oneofKind === 'blockHeader')
      DenunciationBlockHeader.internalBinaryWrite(
        message.entry.blockHeader,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* massa.model.v1.DenunciationEndorsement endorsement = 2; */
    if (message.entry.oneofKind === 'endorsement')
      DenunciationEndorsement.internalBinaryWrite(
        message.entry.endorsement,
...
class DenunciationBlockHeader$Type extends MessageType<DenunciationBlockHeader> {
  ...
  create(
    value?: PartialMessage<DenunciationBlockHeader>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DenunciationBlockHeader,
  ): DenunciationBlockHeader {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
...
class DenunciationEndorsement$Type extends MessageType<DenunciationEndorsement> {
  ...
  create(
    value?: PartialMessage<DenunciationEndorsement>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: DenunciationEndorsement,
  ): DenunciationEndorsement {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
