...
class Block$Type extends MessageType<Block> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.SignedBlockHeader header */ 1:
          message.header = SignedBlockHeader.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.header,
  ...
  internalBinaryWrite(
    ...
    if (message.header)
      SignedBlockHeader.internalBinaryWrite(
        message.header,
...
class FilledBlock$Type extends MessageType<FilledBlock> {
      ...
      switch (fieldNo) {
        ...
        case /* repeated massa.model.v1.FilledOperationEntry operations */ 2:
          message.operations.push(
            FilledOperationEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.operations.length; i++)
      FilledOperationEntry.internalBinaryWrite(
...
class BlockHeader$Type extends MessageType<BlockHeader> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.UInt32Value announced_version */ 2:
          message.announcedVersion = UInt32Value.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.announcedVersion,
          );
          break;
        ...
        case /* repeated massa.model.v1.SignedEndorsement endorsements */ 6:
          message.endorsements.push(
            SignedEndorsement.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    if (message.announcedVersion)
      UInt32Value.internalBinaryWrite(
        message.announcedVersion,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Block content */ 1:
          message.content = Block.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content,
...
class SignedBlockHeader$Type extends MessageType<SignedBlockHeader> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.BlockHeader content */ 1:
          message.content = BlockHeader.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content,
  ...
  internalBinaryWrite(
    ...
    if (message.content)
      BlockHeader.internalBinaryWrite(
        message.content,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    super('massa.model.v1.BlockWrapper', [
      {
        ...
        name: 'status',
        kind: 'enum',
        T: () => ['massa.model.v1.BlockStatus', BlockStatus, 'BLOCK_STATUS_'],
      },
