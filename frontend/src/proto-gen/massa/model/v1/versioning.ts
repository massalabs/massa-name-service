  ...
  constructor() {
    super('massa.model.v1.MipStatusEntry', [
      { no: 1, name: 'mip_info', kind: 'message', T: () => MipInfo },
      {
        ...
        kind: 'enum',
        T: () => [
          'massa.model.v1.ComponentStateId',
          ComponentStateId,
          'COMPONENT_STATE_ID_',
        ],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.MipInfo mip_info */ 1:
          message.mipInfo = MipInfo.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.mipInfo,
...
class MipInfo$Type extends MessageType<MipInfo> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.NativeTime start */ 3:
          message.start = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.start,
        ...
        case /* massa.model.v1.NativeTime timeout */ 4:
          message.timeout = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.timeout,
        ...
        case /* massa.model.v1.NativeTime activation_delay */ 5:
          message.activationDelay = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* repeated massa.model.v1.MipComponentEntry components */ 6:
          message.components.push(
            MipComponentEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.components.length; i++)
      MipComponentEntry.internalBinaryWrite(
