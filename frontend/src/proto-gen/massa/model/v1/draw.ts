...
class SlotDraw$Type extends MessageType<SlotDraw> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue block_producer */ 2:
          message.blockProducer = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* repeated massa.model.v1.EndorsementDraw endorsement_draws */ 3:
          message.endorsementDraws.push(
            EndorsementDraw.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.endorsementDraws.length; i++)
      EndorsementDraw.internalBinaryWrite(
        message.endorsementDraws[i],
