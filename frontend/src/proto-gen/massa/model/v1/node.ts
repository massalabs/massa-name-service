...
class NodeStatus$Type extends MessageType<NodeStatus> {
  constructor() {
    super('massa.model.v1.NodeStatus', [
      ...
      {
        no: 9,
        name: 'last_executed_final_slot',
        kind: 'message',
        T: () => Slot,
      },
      {
        no: 10,
        name: 'last_executed_speculative_slot',
        kind: 'message',
        T: () => Slot,
      },
      {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.NativeTime current_time */ 4:
          message.currentTime = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.currentTime,
        ...
        case /* massa.model.v1.NativeTime current_cycle_time */ 6:
          message.currentCycleTime = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.currentCycleTime,
          );
          break;
        case /* massa.model.v1.NativeTime next_cycle_time */ 7:
          message.nextCycleTime = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.nextCycleTime,
          );
          break;
        case /* repeated massa.model.v1.ConnectedNode connected_nodes */ 8:
          message.connectedNodes.push(
            ConnectedNode.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        case /* massa.model.v1.Slot last_executed_final_slot */ 9:
          message.lastExecutedFinalSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* massa.model.v1.Slot last_executed_speculative_slot */ 10:
          message.lastExecutedSpeculativeSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lastExecutedSpeculativeSlot,
          );
          break;
        ...
        case /* massa.model.v1.ConsensusStats consensus_stats */ 12:
          message.consensusStats = ConsensusStats.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* massa.model.v1.PoolStats pool_stats */ 13:
          message.poolStats = PoolStats.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.poolStats,
        ...
        case /* massa.model.v1.NetworkStats network_stats */ 14:
          message.networkStats = NetworkStats.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* massa.model.v1.ExecutionStats execution_stats */ 15:
          message.executionStats = ExecutionStats.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* massa.model.v1.CompactConfig config */ 16:
          message.config = CompactConfig.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.config,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.connectedNodes.length; i++)
      ConnectedNode.internalBinaryWrite(
        message.connectedNodes[i],
    ...
    if (message.consensusStats)
      ConsensusStats.internalBinaryWrite(
        message.consensusStats,
    ...
    if (message.networkStats)
      NetworkStats.internalBinaryWrite(
        message.networkStats,
    ...
    if (message.config)
      CompactConfig.internalBinaryWrite(
        message.config,
...
class CompactConfig$Type extends MessageType<CompactConfig> {
  constructor() {
    super('massa.model.v1.CompactConfig', [
      ...
      {
        no: 6,
        name: 'operation_validity_periods',
        kind: 'scalar',
        T: 4 /* ScalarType.UINT64*/,
        L: 0 /* LongType.BIGINT*/,
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.NativeTime genesis_timestamp */ 1:
          message.genesisTimestamp = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.genesisTimestamp,
          );
          break;
        case /* massa.model.v1.NativeTime end_timestamp */ 2:
          message.endTimestamp = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
        ...
        case /* massa.model.v1.NativeTime t0 */ 4:
          message.t0 = NativeTime.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.t0,
        ...
        case /* massa.model.v1.NativeAmount block_reward */ 8:
          message.blockReward = NativeAmount.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.blockReward,
        ...
        case /* massa.model.v1.NativeAmount roll_price */ 9:
          message.rollPrice = NativeAmount.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.rollPrice,
