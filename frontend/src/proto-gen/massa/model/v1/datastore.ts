    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated massa.model.v1.AddressKeyEntry address_key_entries */ 1:
          message.addressKeyEntries.push(
            AddressKeyEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
