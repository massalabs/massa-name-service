...
class SignedEndorsement$Type extends MessageType<SignedEndorsement> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Endorsement content */ 1:
          message.content = Endorsement.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.content,
  ...
  internalBinaryWrite(
    ...
    if (message.content)
      Endorsement.internalBinaryWrite(
        message.content,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.SignedEndorsement endorsement */ 4:
          message.endorsement = SignedEndorsement.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.endorsement,
