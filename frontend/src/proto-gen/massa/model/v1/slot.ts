...
class Slot$Type extends MessageType<Slot> {
  ...
  create(value?: PartialMessage<Slot>): Slot {
    ...
    if (value !== undefined) reflectionMergePartial<Slot>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated massa.model.v1.Slot slots */ 1:
          message.slots.push(
            Slot.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
        default:
          let u = options.readUnknownField;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Slot start_slot */ 1:
          message.startSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.startSlot,
        ...
        case /* massa.model.v1.Slot end_slot */ 2:
          message.endSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.endSlot,
