...
class SlotExecutionOutput$Type extends MessageType<SlotExecutionOutput> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.ExecutionOutput execution_output */ 2:
          message.executionOutput = ExecutionOutput.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.executionOutput)
      ExecutionOutput.internalBinaryWrite(
        message.executionOutput,
...
class FinalizedExecutionOutput$Type extends MessageType<FinalizedExecutionOutput> {
  ...
  create(
    value?: PartialMessage<FinalizedExecutionOutput>,
  ): FinalizedExecutionOutput {
    const message = {};
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: FinalizedExecutionOutput,
  ): FinalizedExecutionOutput {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
...
class ExecutionOutput$Type extends MessageType<ExecutionOutput> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.StringValue block_id */ 2:
          message.blockId = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.blockId,
        ...
        case /* massa.model.v1.StateChanges state_changes */ 4:
          message.stateChanges = StateChanges.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    if (message.stateChanges)
      StateChanges.internalBinaryWrite(
        message.stateChanges,
...
class ScExecutionEvent$Type extends MessageType<ScExecutionEvent> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.ScExecutionEventContext context */ 1:
          message.context = ScExecutionEventContext.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.context,
  ...
  internalBinaryWrite(
    ...
    if (message.context)
      ScExecutionEventContext.internalBinaryWrite(
        message.context,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class ScExecutionEventContext$Type extends MessageType<ScExecutionEventContext> {
  ...
  create(
    value?: PartialMessage<ScExecutionEventContext>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ScExecutionEventContext,
  ): ScExecutionEventContext {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Slot origin_slot */ 1:
          message.originSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.originSlot,
        ...
        case /* google.protobuf.StringValue origin_operation_id */ 5:
          message.originOperationId = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
class ScExecutionEventsStatus$Type extends MessageType<ScExecutionEventsStatus> {
  ...
  create(
    value?: PartialMessage<ScExecutionEventsStatus>,
  ): ScExecutionEventsStatus {
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ScExecutionEventsStatus,
  ): ScExecutionEventsStatus {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated massa.model.v1.ScExecutionEventStatus status */ 1:
          ...
          else message.status.push(reader.int32());
          break;
        default:
          let u = options.readUnknownField;
          if (u === 'throw')
...
class StateChanges$Type extends MessageType<StateChanges> {
  constructor() {
    super('massa.model.v1.StateChanges', [
      ...
      {
        no: 2,
        name: 'async_pool_changes',
        kind: 'message',
        repeat: 1 /* RepeatType.PACKED*/,
        T: () => AsyncPoolChangeEntry,
      },
      {
        no: 4,
        name: 'executed_ops_changes',
        kind: 'message',
        repeat: 1 /* RepeatType.PACKED*/,
        T: () => ExecutedOpsChangeEntry,
      },
      {
        no: 5,
        name: 'executed_denunciations_changes',
        kind: 'message',
        repeat: 1 /* RepeatType.PACKED*/,
        T: () => DenunciationIndex,
      },
      {
        no: 6,
        name: 'execution_trail_hash_change',
        kind: 'message',
        T: () => SetOrKeepString,
      },
    ]);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated massa.model.v1.LedgerChangeEntry ledger_changes */ 1:
          message.ledgerChanges.push(
            LedgerChangeEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated massa.model.v1.AsyncPoolChangeEntry async_pool_changes */ 2:
          message.asyncPoolChanges.push(
            AsyncPoolChangeEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated massa.model.v1.ExecutedOpsChangeEntry executed_ops_changes */ 4:
          message.executedOpsChanges.push(
            ExecutedOpsChangeEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* repeated massa.model.v1.DenunciationIndex executed_denunciations_changes */ 5:
          message.executedDenunciationsChanges.push(
            DenunciationIndex.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* massa.model.v1.SetOrKeepString execution_trail_hash_change */ 6:
          message.executionTrailHashChange = SetOrKeepString.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.executionTrailHashChange,
          );
          break;
        default:
          let u = options.readUnknownField;
...
class ExecutedOpsChangeEntry$Type extends MessageType<ExecutedOpsChangeEntry> {
  constructor() {
    super('massa.model.v1.ExecutedOpsChangeEntry', [
      ...
      },
      {
        ...
        name: 'value',
        kind: 'message',
        T: () => ExecutedOpsChangeValue,
      },
    ]);
  }
  create(
    value?: PartialMessage<ExecutedOpsChangeEntry>,
  ): ExecutedOpsChangeEntry {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.ExecutedOpsChangeValue value */ 2:
          message.value = ExecutedOpsChangeValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.value,
  ...
  internalBinaryWrite(
    ...
    if (message.value)
      ExecutedOpsChangeValue.internalBinaryWrite(
        message.value,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class ExecutedOpsChangeValue$Type extends MessageType<ExecutedOpsChangeValue> {
    ...
    super('massa.model.v1.ExecutedOpsChangeValue', [
      {
        ...
        kind: 'enum',
        T: () => [
          'massa.model.v1.OperationExecutionStatus',
          OperationExecutionStatus,
          'OPERATION_EXECUTION_STATUS_',
        ],
      },
  ...
  create(
    value?: PartialMessage<ExecutedOpsChangeValue>,
  ): ExecutedOpsChangeValue {
    const message = { status: 0 };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
...
class AsyncPoolChangeEntry$Type extends MessageType<AsyncPoolChangeEntry> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.AsyncPoolChangeValue value */ 2:
          message.value = AsyncPoolChangeValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.value,
  ...
  internalBinaryWrite(
    ...
    if (message.value)
      AsyncPoolChangeValue.internalBinaryWrite(
        message.value,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class AsyncPoolChangeValue$Type extends MessageType<AsyncPoolChangeValue> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.AsyncMessage created_message */ 2:
          message.message = {
            oneofKind: 'createdMessage',
            createdMessage: AsyncMessage.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.message as any).createdMessage,
            ),
          };
          break;
        case /* massa.model.v1.AsyncMessageUpdate updated_message */ 3:
          message.message = {
            oneofKind: 'updatedMessage',
            updatedMessage: AsyncMessageUpdate.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.message as any).updatedMessage,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.message.oneofKind === 'createdMessage')
      AsyncMessage.internalBinaryWrite(
    ...
    if (message.message.oneofKind === 'updatedMessage')
      AsyncMessageUpdate.internalBinaryWrite(
...
class AsyncMessage$Type extends MessageType<AsyncMessage> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Slot emission_slot */ 1:
          message.emissionSlot = Slot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.emissionSlot,
          );
          break;
        ...
        case /* massa.model.v1.NativeAmount fee */ 7:
          message.fee = NativeAmount.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.fee,
        ...
        case /* massa.model.v1.AsyncMessageTrigger trigger */ 12:
          message.trigger = AsyncMessageTrigger.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.trigger,
  ...
  internalBinaryWrite(
    ...
    if (message.trigger)
      AsyncMessageTrigger.internalBinaryWrite(
        message.trigger,
...
class AsyncMessageUpdate$Type extends MessageType<AsyncMessageUpdate> {
  constructor() {
    super('massa.model.v1.AsyncMessageUpdate', [
      ...
      { no: 11, name: 'data', kind: 'message', T: () => SetOrKeepBytes },
      {
        ...
        name: 'trigger',
        kind: 'message',
        T: () => SetOrKeepAsyncMessageTrigger,
      },
      {
        no: 13,
        name: 'can_be_executed',
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.SetOrKeepSlot emission_slot */ 1:
          message.emissionSlot = SetOrKeepSlot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.emissionSlot,
        ...
        case /* massa.model.v1.SetOrKeepUint64 emission_index */ 2:
          message.emissionIndex = SetOrKeepUint64.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.emissionIndex,
          );
          break;
        case /* massa.model.v1.SetOrKeepString sender */ 3:
          message.sender = SetOrKeepString.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.sender,
        ...
        case /* massa.model.v1.SetOrKeepString destination */ 4:
          message.destination = SetOrKeepString.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.destination,
        ...
        case /* massa.model.v1.SetOrKeepString handler */ 5:
          message.handler = SetOrKeepString.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.handler,
        ...
        case /* massa.model.v1.SetOrKeepUint64 max_gas */ 6:
          message.maxGas = SetOrKeepUint64.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.maxGas,
        ...
        case /* massa.model.v1.SetOrKeepUint64 fee */ 7:
          message.fee = SetOrKeepUint64.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.fee,
        ...
        case /* massa.model.v1.SetOrKeepUint64 coins */ 8:
          message.coins = SetOrKeepUint64.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.coins,
        ...
        case /* massa.model.v1.SetOrKeepSlot validity_start */ 9:
          message.validityStart = SetOrKeepSlot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.validityStart,
        ...
        case /* massa.model.v1.SetOrKeepSlot validity_end */ 10:
          message.validityEnd = SetOrKeepSlot.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.validityEnd,
        ...
        case /* massa.model.v1.SetOrKeepBytes data */ 11:
          message.data = SetOrKeepBytes.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.data,
        ...
        case /* massa.model.v1.SetOrKeepAsyncMessageTrigger trigger */ 12:
          message.trigger = SetOrKeepAsyncMessageTrigger.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.trigger,
        ...
        case /* massa.model.v1.SetOrKeepBool can_be_executed */ 13:
          message.canBeExecuted = SetOrKeepBool.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.canBeExecuted,
          );
          break;
        default:
          let u = options.readUnknownField;
  ...
  internalBinaryWrite(
    ...
    if (message.emissionSlot)
      SetOrKeepSlot.internalBinaryWrite(
        message.emissionSlot,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.emissionIndex)
      SetOrKeepUint64.internalBinaryWrite(
        message.emissionIndex,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.data)
      SetOrKeepBytes.internalBinaryWrite(
        message.data,
    ...
    if (message.trigger)
      SetOrKeepAsyncMessageTrigger.internalBinaryWrite(
        message.trigger,
        writer.tag(12, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.canBeExecuted)
      SetOrKeepBool.internalBinaryWrite(
        message.canBeExecuted,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.Slot set */ 1:
          message.change = {
            oneofKind: 'set',
            set: Slot.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
            ),
          };
          break;
        case /* massa.model.v1.Empty keep */ 2:
          message.change = {
            oneofKind: 'keep',
            keep: Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).keep,
            ),
          };
          break;
        default:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.UInt64Value set */ 1:
          message.change = {
            oneofKind: 'set',
            set: UInt64Value.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.StringValue set */ 1:
          message.change = {
            oneofKind: 'set',
            set: StringValue.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.BytesValue set */ 1:
          message.change = {
            oneofKind: 'set',
            set: BytesValue.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* google.protobuf.BoolValue set */ 1:
          message.change = {
            oneofKind: 'set',
            set: BoolValue.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
...
class SetOrKeepAsyncMessageTrigger$Type extends MessageType<SetOrKeepAsyncMessageTrigger> {
  ...
  create(
    value?: PartialMessage<SetOrKeepAsyncMessageTrigger>,
    ...
    if (value !== undefined)
      reflectionMergePartial<SetOrKeepAsyncMessageTrigger>(
        this,
        message,
        value,
      );
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SetOrKeepAsyncMessageTrigger,
  ): SetOrKeepAsyncMessageTrigger {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.AsyncMessageTrigger set */ 1:
          message.change = {
            oneofKind: 'set',
            set: AsyncMessageTrigger.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
 ...
 */
export const SetOrKeepAsyncMessageTrigger =
  new SetOrKeepAsyncMessageTrigger$Type();
// @generated message type with reflection information, may provide speed optimized methods
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* google.protobuf.BytesValue datastore_key */ 2:
          message.datastoreKey = BytesValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
...
class LedgerChangeEntry$Type extends MessageType<LedgerChangeEntry> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.LedgerChangeValue value */ 2:
          message.value = LedgerChangeValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.value,
  ...
  internalBinaryWrite(
    ...
    if (message.value)
      LedgerChangeValue.internalBinaryWrite(
        message.value,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class LedgerChangeValue$Type extends MessageType<LedgerChangeValue> {
    ...
    super('massa.model.v1.LedgerChangeValue', [
      {
        ...
        kind: 'enum',
        T: () => [
          'massa.model.v1.LedgerChangeType',
          LedgerChangeType,
          'LEDGER_CHANGE_TYPE_',
        ],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* massa.model.v1.LedgerEntry created_entry */ 2:
          message.entry = {
            oneofKind: 'createdEntry',
            createdEntry: LedgerEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.entry as any).createdEntry,
            ),
          };
          break;
        case /* massa.model.v1.LedgerEntryUpdate updated_entry */ 3:
          message.entry = {
            oneofKind: 'updatedEntry',
            updatedEntry: LedgerEntryUpdate.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.entry as any).updatedEntry,
            ),
          };
          break;
        default:
  ...
  internalBinaryWrite(
    ...
    if (message.entry.oneofKind === 'createdEntry')
      LedgerEntry.internalBinaryWrite(
        message.entry.createdEntry,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* massa.model.v1.LedgerEntryUpdate updated_entry = 3; */
    if (message.entry.oneofKind === 'updatedEntry')
      LedgerEntryUpdate.internalBinaryWrite(
        message.entry.updatedEntry,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    let u = options.writeUnknownFields;
...
class LedgerEntry$Type extends MessageType<LedgerEntry> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated massa.model.v1.BytesMapFieldEntry datastore */ 3:
          message.datastore.push(
            BytesMapFieldEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.datastore.length; i++)
      BytesMapFieldEntry.internalBinaryWrite(
        message.datastore[i],
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class LedgerEntryUpdate$Type extends MessageType<LedgerEntryUpdate> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.SetOrKeepBalance balance */ 1:
          message.balance = SetOrKeepBalance.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.balance,
        ...
        case /* massa.model.v1.SetOrKeepBytes bytecode */ 2:
          message.bytecode = SetOrKeepBytes.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.bytecode,
        ...
        case /* repeated massa.model.v1.SetOrDeleteDatastoreEntry datastore */ 3:
          message.datastore.push(
            SetOrDeleteDatastoreEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
  ...
  internalBinaryWrite(
    ...
    if (message.balance)
      SetOrKeepBalance.internalBinaryWrite(
        message.balance,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    for (let i = 0; i < message.datastore.length; i++)
      SetOrDeleteDatastoreEntry.internalBinaryWrite(
        message.datastore[i],
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.NativeAmount set */ 1:
          message.change = {
            oneofKind: 'set',
            set: NativeAmount.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
...
class SetOrDeleteDatastoreEntry$Type extends MessageType<SetOrDeleteDatastoreEntry> {
  ...
  create(
    value?: PartialMessage<SetOrDeleteDatastoreEntry>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: SetOrDeleteDatastoreEntry,
  ): SetOrDeleteDatastoreEntry {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.BytesMapFieldEntry set */ 1:
          message.change = {
            oneofKind: 'set',
            set: BytesMapFieldEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).set,
        ...
        case /* massa.model.v1.Empty delete */ 2:
          message.change = {
            oneofKind: 'delete',
            delete: Empty.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.change as any).delete,
            ),
          };
          break;
        default:
...
class ReadOnlyExecutionCall$Type extends MessageType<ReadOnlyExecutionCall> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated massa.model.v1.ExecutionStackElement call_stack */ 2:
          message.callStack.push(
            ExecutionStackElement.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
            ),
        ...
        case /* massa.model.v1.BytecodeExecution bytecode_call */ 3:
          message.target = {
            oneofKind: 'bytecodeCall',
            bytecodeCall: BytecodeExecution.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.target as any).bytecodeCall,
            ),
          };
          break;
        case /* massa.model.v1.FunctionCall function_call */ 4:
          message.target = {
            oneofKind: 'functionCall',
            functionCall: FunctionCall.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.target as any).functionCall,
            ),
          };
          break;
        case /* google.protobuf.StringValue caller_address */ 5:
          message.callerAddress = StringValue.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
  ...
  internalBinaryWrite(
    ...
    for (let i = 0; i < message.callStack.length; i++)
      ExecutionStackElement.internalBinaryWrite(
        message.callStack[i],
        writer.tag(2, WireType.LengthDelimited).fork(),
        options,
      ).join();
    ...
    if (message.target.oneofKind === 'bytecodeCall')
      BytecodeExecution.internalBinaryWrite(
        message.target.bytecodeCall,
        writer.tag(3, WireType.LengthDelimited).fork(),
        options,
      ).join();
    /* massa.model.v1.FunctionCall function_call = 4; */
    if (message.target.oneofKind === 'functionCall')
      FunctionCall.internalBinaryWrite(
        message.target.functionCall,
        writer.tag(4, WireType.LengthDelimited).fork(),
        options,
      ).join();
...
class BytecodeExecution$Type extends MessageType<BytecodeExecution> {
  ...
  create(value?: PartialMessage<BytecodeExecution>): BytecodeExecution {
    const message = {
      ...
      operationDatastore: new Uint8Array(0),
    };
    globalThis.Object.defineProperty(message, MESSAGE_TYPE, {
      enumerable: false,
      value: this,
...
class ReadOnlyExecutionOutput$Type extends MessageType<ReadOnlyExecutionOutput> {
  ...
  create(
    value?: PartialMessage<ReadOnlyExecutionOutput>,
  ...
  internalBinaryRead(
    ...
    length: number,
    options: BinaryReadOptions,
    target?: ReadOnlyExecutionOutput,
  ): ReadOnlyExecutionOutput {
    let message = target ?? this.create();
    let end = reader.pos + length;
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* massa.model.v1.ExecutionOutput out */ 1:
          message.out = ExecutionOutput.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.out,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated massa.model.v1.BytesMapFieldEntry operation_datastore */ 4:
          message.operationDatastore.push(
            BytesMapFieldEntry.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
